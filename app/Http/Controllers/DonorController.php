...
class DonorController extends Controller
{
    ...
    public function store(Request $request)
    {
            ...
            if ($request->hasFile('profile')) {
                ...
                if (!$user->admin) {
                    $admin = new Donor($request->except('profile'));
            ...
            return redirect()->route('donor.home')->with('message', 'Profile updated successfully.');
    }
    ...
    public function editProfile(Request $request)
    {
        ...
        return view('donor.profile.profile', compact('user', 'donor', 'redirectToTab'));
    }

    public function updateProfile(Request $request)
    {
        $user = Auth::user();
        $donor = Auth::user()->donors()->firstOrNew([]);
        ...
        if ($validator->fails()) {
            //dd($validator->errors());
            return redirect()->route('donor.profile.profile')
