        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form method="POST" action="{{ route('orphanage.dashboard') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="dor">{{ __('Registration Certificate Number') }}</label>
                                <input id="dor" type="text" class="form-control" name="dor" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
