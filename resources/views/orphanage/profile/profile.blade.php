          ...
          <div class="card card-info card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                src="{{ asset('storage/profiles/' . $orphanage->profile) }}"
                     alt="User profile picture">
              </div>

              <h3 class="profile-username text-center">{{ $user->name }}</h3>

              <p class="text-muted text-center"> {{ $orphanage->dor }}</p>
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'timeline' ? 'active' : '' }}" id="timeline">
                  <!-- The timeline -->
                    <form class="form-horizontal" method="POST" action="{{ route('orphanage.profile.profile') }}">
                      @csrf
                      @method('PUT')
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'settings' ? 'active' : '' }}" id="settings">
                    <form class="form-horizontal" method="POST" action="{{ route('orphanage.profile.profile') }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="phone" id="phone" class="form-control" value="{{ $orphanage->phone }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Current City</label>
                        <div class="col-sm-10">
                          <input type="text" name="city" id="city" class="form-control" value="{{ $orphanage->city }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Address</label>
                        <div class="col-sm-10">
                          <input type="text" name="address" id="address" class="form-control" value="{{ $orphanage->address }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">
