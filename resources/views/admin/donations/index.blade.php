      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><button class="btn btn-info"><a  style="color: #fff;"href="{{ url('admin/donations/create')}}">Add Donation</a></button></li>
            </ol>
        </div><!-- /.col -->
      </div>
    </div><!-- /.container-fluid -->
                        ...
                        @foreach ($donations as $donation)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <a href="{{ route('donations.edit', $donation->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
